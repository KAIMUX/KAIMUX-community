...
public class ModalForm implements IForm {
    ...
    public ModalForm(String title, String message, Button button1, Button button2, ICloseForm onClose) {
        this.title = title;
    ...
    public Form build(FloodgateApi api, Player player) {
        var builder = org.geysermc.cumulus.form.ModalForm.builder()
                ...
                .button1(this.button1.getStringText())
                .button2(this.button2.getStringText());
    ...
    public static ModalForm of(String title, String message, Button button1, Button button2, ICloseForm onClose) {
